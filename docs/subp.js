...
function changeBgToLight(){
  ...
  h2change[0].style.color = 'black';
  pchange[0].style.color = 'black';
  pchange[1].style.color = 'black';
  pchange[2].style.color = 'black';
...
function changeBgToDark(){
  ...
  h2change[0].style.color = '#F7F7F7';
  pchange[0].style.color = '#F7F7F7';
  pchange[1].style.color = '#F7F7F7';
  pchange[2].style.color = '#F7F7F7';
